...
Public Sub OutputListOfIndexes()
    ...
    Const aeIndexList As String = "OutputListOfIndexes.txt"
    Dim aestrSourceLocation As String
    aestrSourceLocation = "C:\ae\aegit\aerc\src\"

    Dim fle As Integer
    fle = FreeFile()
    Open aestrSourceLocation & aeIndexList For Output As #fle
    Close fle
...
Private Sub OutputTableListOfIndexesDAO(ByVal tdfIn As DAO.TableDef)
    ...
    Dim aestrSourceLocation As String
    aestrSourceLocation = "C:\ae\aegit\aerc\src\"
    Open aestrSourceLocation & aeIndexList For Append As #fle
